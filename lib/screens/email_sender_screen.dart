        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Send direct emails using Microsoft 365 (Office 365).',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        'This screen uses your Microsoft 365 credentials from .env to send emails directly via Microsoft Graph API.',

...
/// Unified Auth Screen for LinkSpec: Fixed Type Collision and Deep Link Logic.
...
class _LinkSpecAuthScreenState extends State<LinkSpecAuthScreen> {
  ...
  void _listen() {
    ...
    // Web Fallback: Check for recovery parameters in the URL
    final u = Uri.base;
  ...
  Future<void> _entry() async {
    ...
    try {
      ...
      if (e.toString().contains('429')) {
        _msg('Rate limited. Accessing reset view...', e: true);
        setState(() => _s = AuthState.resetting);
      } else {
